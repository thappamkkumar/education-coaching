    ...
    <section 
      ...
      >
        ...
        <div className="relative w-full h-[360px] sm:h-[420px] md:h-[520px] flex justify-center">
          {/* IMAGE 1 */}
          <div
            className="absolute top-4 left-6 sm:left-10 w-40 h-56 sm:w-48 sm:h-64 md:w-56 md:h-72 lg:w-60 lg:h-80 rounded-3xl overflow-hidden shadow-xl transform -rotate-3"
          >
            <Image
          ...
          {/* IMAGE 2 */}
          <div
            className="absolute bottom-4 right-6 sm:right-10 w-48 h-64 sm:w-56 sm:h-72 md:w-60 md:h-80 lg:w-72 lg:h-96 rounded-3xl overflow-hidden shadow-xl transform rotate-2"
          >
            <Image
